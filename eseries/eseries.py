...
class ESeries:
    ...
    def iterate_up(self, value: float) -> Generator[float, None, None]:
        exponent_offset = floor(log10(value) - self.base_exponent)
        index = bisect_left(self.base_values, value / (10 ** exponent_offset))
    ...
    def iterate_down(self, value: float) -> Generator[float, None, None]:
        exponent_offset = floor(log10(value) - self.base_exponent)
        index = bisect_right(self.base_values, value / (10 ** exponent_offset)) - 1
            
        while True:
            if index < 0:
                index = len(self.base_values) - 1
                exponent_offset -= 1
...
E3 = ESeries('E3', 0.4, 2, (10, 22, 47) )
E6 = ESeries('E6', 0.2, 2, (10, 15, 22, 33, 47, 68) )
E12 = ESeries('E12', 0.1, 2, (10, 12, 15, 18, 22, 27, 33, 39, 47, 56, 68, 82) )
E24 = ESeries('E24', 0.05, 2, (10, 11, 12, 13, 15, 16, 18, 20, 22, 24, 27, 30, 33, 36, 39, 43, 47, 51, 56, 62, 68, 75,
                               82, 91) )
E48 = ESeries('E48', 0.02, 3, (100, 105, 110, 115, 121, 127, 133, 140, 147, 154, 162, 169, 178, 187, 196, 205, 215,
...
E96 = ESeries('E96', 0.01, 3, (100, 102, 105, 107, 110, 113, 115, 118, 121, 124, 127, 130, 133, 137, 140, 143, 147,
...
E192 = ESeries('E192', 0.005, 3, (100, 101, 102, 104, 105, 106, 107, 109, 110, 111, 113, 114, 115, 117, 118, 120, 121,
